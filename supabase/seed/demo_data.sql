...
INSERT INTO classes (id, club_id, name, coach, level, day, time, location, spots_available, spots_total, price, description, visible, visibility, start_date, end_date)
VALUES
  -- Sha Tin (4 classes)
  ('30000000-0001-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', '週一兒童初班',     'Coach Chan Ka Ming',  'Beginner',     'Monday',    '4:30 PM - 5:30 PM', '1 號場', 6,  8,  280, '專為 6-10 歲小朋友設計，著重基本揮拍同樂趣。', true, 'public',   '2026-04-01', '2026-06-30'),
  ('30000000-0001-0000-0000-000000000002', '10000000-0000-0000-0000-000000000001', '週二成人初班',     'Coach Chan Ka Ming',  'Beginner',     'Tuesday',   '7:00 PM - 8:30 PM', '2 號場', 4,  8,  350, '零基礎成人適用，打好基本功。',                 true, 'public',   '2026-04-01', '2026-06-30'),
  ('30000000-0001-0000-0000-000000000003', '10000000-0000-0000-0000-000000000001', '週六混合班',       'Coach Cheng Pui Yi',  'Intermediate', 'Saturday',  '9:00 AM - 11:00 AM','室內 A', 5,  10, 420, '初中級混合對打，教練即場糾正動作。',           true, 'public',   '2026-04-01', '2026-06-30'),
  ('30000000-0001-0000-0000-000000000004', '10000000-0000-0000-0000-000000000001', '私人進階班',       'Coach Ho Chun Yin',   'Advanced',     'Thursday',  '8:00 PM - 9:30 PM', '室內 B', 2,  4,  680, '限四人小班，針對比賽技術。',                   true, 'members',  '2026-04-01', '2026-06-30'),

  -- Victoria Park (4 classes)
  ('30000000-0002-0000-0000-000000000001', '10000000-0000-0000-0000-000000000002', '維園成人入門',     'Coach Tsui Ka Wai',   'Beginner',     'Wednesday', '7:30 PM - 9:00 PM', '中央球場', 6, 10, 320, '港島最抵玩成人班，歡迎新手。',                  true, 'public',   '2026-04-01', '2026-07-30'),
  ('30000000-0002-0000-0000-000000000002', '10000000-0000-0000-0000-000000000002', '維園中級班',       'Coach Wong Siu Fung', 'Intermediate', 'Monday',    '7:00 PM - 9:00 PM', '3 號場',   4, 8,  380, '著重底線穩定同步法移動。',                     true, 'public',   '2026-04-01', '2026-07-30'),
  ('30000000-0002-0000-0000-000000000003', '10000000-0000-0000-0000-000000000002', '週日家庭同樂班',   'Coach Tsui Ka Wai',   'Beginner',     'Sunday',    '10:00 AM - 11:30 AM','4 號場',  7, 12, 260, '親子一齊玩網球。',                             true, 'public',   '2026-04-01', '2026-07-30'),
  ('30000000-0002-0000-0000-000000000004', '10000000-0000-0000-0000-000000000002', '週五進階技術',     'Coach Fung Hei Man',  'Advanced',     'Friday',    '8:00 PM - 9:30 PM', '中央球場', 3, 6,  520, '針對發球、上網、切削技巧。',                   true, 'members',  '2026-04-01', '2026-07-30'),

  -- TKO Academy (4 classes)
  ('30000000-0003-0000-0000-000000000001', '10000000-0000-0000-0000-000000000003', '學院青少年精英',   'Coach Lam Cho Yiu',   'Advanced',     'Tuesday',   '5:00 PM - 7:00 PM', '智能場 1', 4,  8,  580, '比賽導向培訓，配球速追蹤。',                   true, 'public',   '2026-04-01', '2026-12-31'),
  ('30000000-0003-0000-0000-000000000002', '10000000-0000-0000-0000-000000000003', '學院青少年精英',   'Coach Lam Cho Yiu',   'Advanced',     'Thursday',  '5:00 PM - 7:00 PM', '智能場 1', 3,  8,  580, '比賽導向培訓，配球速追蹤。',                   true, 'public',   '2026-04-01', '2026-12-31'),
  ('30000000-0003-0000-0000-000000000003', '10000000-0000-0000-0000-000000000003', '學院成人高級班',   'Coach Leung Yuen Ting','Advanced',     'Saturday',  '2:00 PM - 4:00 PM', '智能場 2', 2,  6,  620, '高級成人，著重戰術應用。',                     true, 'members',  '2026-04-01', '2026-12-31'),
  ('30000000-0003-0000-0000-000000000004', '10000000-0000-0000-0000-000000000003', '體能技術融合',     'Coach Ng Tsz Lok',    'Intermediate', 'Sunday',    '9:00 AM - 11:00 AM','訓練場 A', 5,  10, 460, '體能訓練加技術練習。',                         true, 'public',   '2026-04-01', '2026-12-31'),

  -- Kowloon Tong (4 classes, mostly members-only)
  ('30000000-0004-0000-0000-000000000001', '10000000-0000-0000-0000-000000000004', '會員中級班',       'Coach Wong Siu Fung', 'Intermediate', 'Tuesday',   '7:00 PM - 9:00 PM', '草場 1',   4, 8,  480, '會員專享中級班，草場訓練。',                   true, 'members',  '2026-04-01', '2026-09-30'),
  ('30000000-0004-0000-0000-000000000002', '10000000-0000-0000-0000-000000000004', '女子俱樂部班',     'Coach Yip Wing Shan', 'Intermediate', 'Thursday',  '10:00 AM - 11:30 AM','草場 2', 3, 8,  420, '女士專屬訓練，輕鬆交流。',                     true, 'members',  '2026-04-01', '2026-09-30'),
  ('30000000-0004-0000-0000-000000000003', '10000000-0000-0000-0000-000000000004', '會員內部私教',     'Coach Wong Siu Fung', 'Advanced',     'Saturday',  '7:00 AM - 9:00 AM', '硬地場 1', 0, 2,  950, '只限指定會員。',                               true, 'private',  '2026-04-01', '2026-09-30'),
  ('30000000-0004-0000-0000-000000000004', '10000000-0000-0000-0000-000000000004', '兒童入門班',       'Coach Yip Wing Shan', 'Beginner',     'Saturday',  '9:30 AM - 10:30 AM','草場 1',   8, 10, 360, '4-8 歲小朋友親身體驗網球。',                   true, 'public',   '2026-04-01', '2026-09-30'),

  -- Deep Water Bay (3 classes, premium)
  ('30000000-0005-0000-0000-000000000001', '10000000-0000-0000-0000-000000000005', '紅土高級班',       'Coach Leung Yuen Ting','Advanced',     'Wednesday', '7:30 AM - 9:00 AM', '海景紅土 A', 3, 6,  780, '體驗歐洲式紅土訓練，小班教學。',               true, 'members',  '2026-04-01', '2026-10-31'),
  ('30000000-0005-0000-0000-000000000002', '10000000-0000-0000-0000-000000000005', '海景女子班',       'Coach Yip Wing Shan', 'Intermediate', 'Friday',    '9:30 AM - 11:00 AM','海景紅土 B', 2, 6,  720, '女士會員班，邊打邊睇海。',                     true, 'members',  '2026-04-01', '2026-10-31'),
  ('30000000-0005-0000-0000-000000000003', '10000000-0000-0000-0000-000000000005', '週末進階',         'Coach Fung Hei Man',  'Advanced',     'Saturday',  '4:00 PM - 6:00 PM', '硬地場 1',   4, 8,  650, '進階戰術同發球訓練。',                         true, 'public',   '2026-04-01', '2026-10-31'),

  -- Wong Tai Sin (3 classes, community)
  ('30000000-0006-0000-0000-000000000001', '10000000-0000-0000-0000-000000000006', '社區兒童班',       'Coach Ho Chun Yin',   'Beginner',     'Saturday',  '10:00 AM - 11:30 AM','1 號場',   9, 12, 180, '社區推廣價，7-12 歲。',                        true, 'public',   '2026-04-01', '2026-08-31'),
  ('30000000-0006-0000-0000-000000000002', '10000000-0000-0000-0000-000000000006', '社區成人入門',     'Coach Chan Ka Ming',  'Beginner',     'Wednesday', '8:00 PM - 9:30 PM', '2 號場',   7, 12, 180, '成人零基礎適用。',                             true, 'public',   '2026-04-01', '2026-08-31'),
  ('30000000-0006-0000-0000-000000000003', '10000000-0000-0000-0000-000000000006', '青少年週末班',     'Coach Ho Chun Yin',   'Intermediate', 'Sunday',    '2:00 PM - 4:00 PM', '3 號場',   6, 10, 220, '12-16 歲青少年進階。',                         true, 'public',   '2026-04-01', '2026-08-31'),

  -- Tuen Mun (3 classes)
  ('30000000-0007-0000-0000-000000000001', '10000000-0000-0000-0000-000000000007', '屯門兒童班',       'Coach Ho Chun Yin',   'Beginner',     'Monday',    '4:30 PM - 5:30 PM', '1 號場', 5,  8,  260, '屯門區兒童入門班。',                           true, 'public',   '2026-04-01', '2026-07-31'),
  ('30000000-0007-0000-0000-000000000002', '10000000-0000-0000-0000-000000000007', '屯門成人入門',     'Coach Tsui Ka Wai',   'Beginner',     'Thursday',  '7:30 PM - 9:00 PM', '2 號場', 4,  8,  300, '放工後成人班。',                               true, 'public',   '2026-04-01', '2026-07-31'),
  ('30000000-0007-0000-0000-000000000003', '10000000-0000-0000-0000-000000000007', '屯門體能強化',     'Coach Ng Tsz Lok',    'Intermediate', 'Sunday',    '8:00 AM - 10:00 AM','3 號場', 6,  10, 380, '體能+技術複合訓練。',                          true, 'public',   '2026-04-01', '2026-07-31'),

  -- Tai Po (3 classes)
  ('30000000-0008-0000-0000-000000000001', '10000000-0000-0000-0000-000000000008', '大埔兒童班',       'Coach Chan Ka Ming',  'Beginner',     'Saturday',  '9:00 AM - 10:30 AM','1 號場', 8,  12, 200, '公園兒童班。',                                 true, 'public',   '2026-04-01', '2026-08-31'),
  ('30000000-0008-0000-0000-000000000002', '10000000-0000-0000-0000-000000000008', '大埔成人混合',     'Coach Cheng Pui Yi',  'Intermediate', 'Wednesday', '7:30 PM - 9:00 PM', '2 號場', 5,  10, 260, '成人中級混合班。',                             true, 'public',   '2026-04-01', '2026-08-31'),
  ('30000000-0008-0000-0000-000000000003', '10000000-0000-0000-0000-000000000008', '週日清晨班',       'Coach Chan Ka Ming',  'Beginner',     'Sunday',    '7:00 AM - 8:30 AM', '1 號場', 6,  10, 220, '早晨打波，打完食早餐。',                       true, 'public',   '2026-04-01', '2026-08-31')
ON CONFLICT (id) DO UPDATE SET
  club_id         = EXCLUDED.club_id,
  name            = EXCLUDED.name,
